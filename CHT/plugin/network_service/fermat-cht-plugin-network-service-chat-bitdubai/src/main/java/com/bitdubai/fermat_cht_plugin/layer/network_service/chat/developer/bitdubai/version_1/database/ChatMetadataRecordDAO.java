...
public class ChatMetadataRecordDAO implements DAO {
    ...
    public List<ChatMetadataRecord> getNotificationByDestinationPublicKey(final String destinationPublicKey) throws CantGetNotificationException, NotificationNotFoundException {
        ...
        try {
            ...
            databaseTable.addStringFilter(ChatNetworkServiceDataBaseConstants.CHAT_METADATA_TRANSACTION_RECORD_REMOTEACTORPUBKEY_COLUMN_NAME, destinationPublicKey, DatabaseFilterType.EQUAL);
    ...
    private ChatMetadataRecord constructFrom(DatabaseTableRecord record) {
        ...
        try {
            ...
            chatMetadataRecord.setDate(Timestamp.valueOf(record.getStringValue(ChatNetworkServiceDataBaseConstants.CHAT_METADATA_TRANSACTION_RECORD_DATE_COLUMN_NAME)));
            ...
            chatMetadataRecord.setSentDate(Timestamp.valueOf(record.getStringValue(ChatNetworkServiceDataBaseConstants.CHAT_METADATA_TRANSACTION_RECORD_SENTDATE_COLUMN_NAME)));
    ...
    private void setValuesToRecord(DatabaseTableRecord entityRecord,ChatMetadataRecord chatMetadataRecord) throws CantOpenDatabaseException, CantCreateDatabaseException {
        ...
        entityRecord.setStringValue(ChatNetworkServiceDataBaseConstants.CHAT_METADATA_TRANSACTION_RECORD_DATE_COLUMN_NAME,                        chatMetadataRecord.getDate().toString());
        ...
        entityRecord.setStringValue(ChatNetworkServiceDataBaseConstants.CHAT_METADATA_TRANSACTION_RECORD_SENTDATE_COLUMN_NAME,                    chatMetadataRecord.getSentDate().toString());
